...
# 代理配置
MY_SOCKS_PROXY = os.environ.get('MY_SOCKS_PROXY', '')  # 格式: 'socks5://user:pass@host:port'
MY_HTTP_PROXY = os.environ.get('MY_HTTP_PROXY', '')  # 格式: 'http://host:port'
MY_HTTPS_PROXY = os.environ.get('MY_HTTPS_PROXY', '')  # 格式: 'http://host:port'
